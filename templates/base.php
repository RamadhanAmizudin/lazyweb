...
<html lang="en">
  <head>
    ...
    <style type="text/css">/* Move down content because we have a fixed navbar that is 50px tall */
body {
  padding-top: 50px;
  padding-bottom: 20px;
}</style>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" action="/user/login.php" method="post">
            ...
            <div class="form-group">
              <input type="password" placeholder="Password" name="user" class="form-control">
            </div>
